        ...
        {open && (
          <>
            ...
            <motion.a
              ...
              className="flex items-center gap-2.5 bg-[#25D366] hover:bg-[#20b858] text-white pl-4 pr-5 py-3 rounded-full shadow-lg font-bold text-sm uppercase tracking-widest transition-all hover:-translate-y-0.5"
            >
            ...
            <motion.a
              ...
              className="flex items-center gap-2.5 bg-emerald-600 hover:bg-emerald-500 text-white pl-4 pr-5 py-3 rounded-full shadow-lg font-bold text-sm uppercase tracking-widest transition-all hover:-translate-y-0.5"
            >
