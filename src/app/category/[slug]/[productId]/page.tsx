      ...
      <div className="flex-grow pt-32 pb-24">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-slate-500 mb-10">
            ...
            <span>/</span>
            <Link href={`/category/${slug}`} className="hover:text-emerald-400 transition-colors">{category?.title}</Link>
            <span>/</span>
            <span className="text-emerald-400">{product.name}</span>
          </div>

          <Link href={`/category/${slug}`} className="group inline-flex items-center gap-1 text-emerald-400 text-xs font-bold uppercase tracking-widest mb-8 hover:gap-2 transition-all">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              {/* Added Pulse Stock Indicator here */}
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-950/50 border border-emerald-500/20 rounded-sm">
                  ...
                  <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest">Ready for Delivery</span>
                </div>
              </div>
